...
(function (t, e) {
    ...
    var t = function (t) {
        ...
        function e() {
            k = !0, v = document.getElementById(M.elInitID),
                x = document.createElement("div"),
                W = document.createElement("div"),
                g = document.getElementById("sidebar-toggle"),
                ...
                b.classList = "tss-bg", L = E > 499 ? M.elSubmainWidth : E * M.elSubmainMaxWidth, W.style.width = L + "px", S = L + M.sideHookWidth,
                x.style.transitionDuration = M.moveSpeed + "s", b.style.transitionDuration = M.moveSpeed + "s",
                l()
        }
        ...
        function i(t) {
            document.body.style.overflow = "hidden",
                ...
                b.style.zIndex = 998,
                y = x.getBoundingClientRect().left,
                m = t.changedTouches[0].clientX,
                tsY = t.changedTouches[0].clientY
        }

        function s(t) {
            w = t.changedTouches[0].clientX;
            var tpY = t.changedTouches[0].clientY;
            selX = m - w;
            selY = Math.abs(tsY - tpY);
            ...
            if (e <= 0) {
                if (f) {
                    if (stat == 'y') {
                        m > L && (e += m - L),
                            w <= L && (x.style.transform = "translateX(" + e + "px)");
                        var n = w / L;

                        n > 0 && n < 1 && (b.style.opacity = n * M.opacityBackground)
                    }
                } else {
                    m > L && (e += m - L),
                        w <= L && (x.style.transform = "translateX(" + e + "px)");
        ...
        function o(t) { //shift for start cond
        ...
        function d(t) { //toggle sidebar
            if ($(window).width() <= 767) {
                t.stopPropagation(), f === !1 ? r() : l()
            }
        }

        function a(t) { //close sidebar when touch outside the sidebar
            t.stopPropagation();
            var e = x.getBoundingClientRect().left;
            t.clientX > e + L && l()
        }

        function r() { //open sidebar
